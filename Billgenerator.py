...
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Bill Generator",fg="steel blue",bd=10,anchor='w')
...
def Ref():
    ...
    subtotal=(costoffries +  costoflargefries + costofburger + costoffilet  + costofcheeseburger)
    PayTax=((costoffries +  costoflargefries + costofburger + costoffilet +  costofcheeseburger )*0.05)
    Totalcost=(costoffries +  costoflargefries + costofburger + costoffilet  + costofcheeseburger )

    OverAllCost="Rs.",str( PayTax + Totalcost )
...
lblTax = Label(f1, font=( 'aria' ,16, 'bold' ),text="Tax (5%)",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo.grid(row=1, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Rs 25", fg="steel blue", anchor=W)
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Rs 35", fg="steel blue", anchor=W)
